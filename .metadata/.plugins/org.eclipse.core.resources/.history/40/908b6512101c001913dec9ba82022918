...
public class TestCuentaCorriente {
	...
	public static void main(String[] args) {
		...
		cuentasCorrientes[0] = new CuentaCorriente("Marcos","Monjon","Calle lomo n 35","616584422");
		cuentasCorrientes[1] = new CuentaCorriente("Jose","Zamora","Calle pepito n 35","616402211");
		
		for(CuentaCorriente e: cuentasCorrientes) {
		
			
			if(e.getApellidos() == "Monjon") {
				System.out.println("Es correcto el apellido es " + e.getApellidos());
			}
			else {
